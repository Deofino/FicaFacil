...
--
ALTER TABLE `tb_assunto_materia`
  ADD CONSTRAINT `tb_assunto_materia_ibfk_1` FOREIGN KEY (`idMateria`) REFERENCES `tb_materia` (`idMateria`);

--
-- Limitadores para a tabela `tb_materia`
--
ALTER TABLE `tb_materia`
  ADD CONSTRAINT `tb_materia_ibfk_1` FOREIGN KEY (`idAreaMateria`) REFERENCES `tb_area_materia` (`idAreaMateria`);

--
-- Limitadores para a tabela `tb_questao`
--
ALTER TABLE `tb_questao`
  ADD CONSTRAINT `tb_questao_ibfk_1` FOREIGN KEY (`idAdministrador`) REFERENCES `tb_administrador` (`idAdministrador`),
  ADD CONSTRAINT `tb_questao_ibfk_2` FOREIGN KEY (`idDificuldade`) REFERENCES `tb_dificuldade` (`idDificuldade`),
  ADD CONSTRAINT `tb_questao_ibfk_3` FOREIGN KEY (`idAssuntoMateria`) REFERENCES `tb_assunto_materia` (`idAssuntoMateria`),
  ADD CONSTRAINT `tb_questao_ibfk_4` FOREIGN KEY (`idUniversidade`) REFERENCES `tb_universidade` (`idUniversidade`);

--
-- Limitadores para a tabela `tb_resposta`
--
ALTER TABLE `tb_resposta`
  ADD CONSTRAINT `tb_resposta_ibfk_1` FOREIGN KEY (`idQuestao`) REFERENCES `tb_questao` (`idQuestao`);

--
-- Limitadores para a tabela `tb_simulado`
--
ALTER TABLE `tb_simulado`
  ADD CONSTRAINT `tb_simulado_ibfk_1` FOREIGN KEY (`idCliente`) REFERENCES `tb_cliente` (`idCliente`),
  ADD CONSTRAINT `tb_simulado_ibfk_2` FOREIGN KEY (`idQuestao`) REFERENCES `tb_questao` (`idQuestao`);

--
-- Limitadores para a tabela `tb_sugestao_video`
--
ALTER TABLE `tb_sugestao_video`
  ADD CONSTRAINT `tb_sugestao_video_ibfk_1` FOREIGN KEY (`idQuestao`) REFERENCES `tb_questao` (`idQuestao`);
COMMIT;
