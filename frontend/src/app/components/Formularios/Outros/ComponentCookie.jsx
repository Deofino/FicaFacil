    ...
    <div className="c-termos">
      ...
      <article className="c-termos__content">
        ...
        <span className="c-termos__texto bold">
          1. Aceitação aos Termos de Uso 1.1
        </span>
        <span className="c-termos__texto">
          Ao se cadastrar em nossa Plataforma, você concorda, expressa e
          ...
          condições, conforme abaixo detalhadas. 1.2. Você está autorizado a
          utilizar os Serviços do Fica Fácil somente se você concorda com todas
          regras e condições estabelecidas nos Termos de Uso. 1.3. Se você não
          concorda com estes Termos de Uso, você não está autorizado a acessar
          ou utilizar os Serviços oferecidos em nossa Plataforma. A utilização
          dos Serviços Fica Fácil está expressamente condicionada ao seu
          consentimento às regras dos Termos de Uso, conforme solicitado quando
          do seu cadastro em nossa Plataforma. 1.4. Senha e Segurança: Quando
          você completar o seu processo de registro, você criará uma senha que
          habilitará seu acesso à nossa Plataforma. Você concorda em manter a
          confidencialidade da sua senha e é inteiramente responsável por
          qualquer dano resultante da não manutenção dessa confidencialidade e
          de todas as atividades que ocorrerem através do uso de sua senha. Você
          concorda em nos notificar imediatamente em caso de qualquer acesso não
          autorizado de sua senha ou outra quebra de segurança 2. Restrições e
          privacidade 2.1. Restrições: Ao usar nossa Plataforma, você concorda
          que as Suas Informações: (a) não devem ser fraudulentas; (b) não devem
          infringir nenhum direito autoral de terceiros, patente, marca
          registrada, direito de distribuição ou outro direito de propriedade
          intelectual, de publicação ou privacidade; (c) não devem violar
          nenhuma lei, estatuto, ordenação ou regulamento; (d) não devem ser
          difamatórias, caluniosas, ameaçadoras ou abusivas; (e) não devem ser
          obscenas ou conter pornografia, pornografia infantil, ou fotos de
          pessoas despidas; (f) não devem conter vírus, cavalos de troia, worms,
          time bombs, cancelbots, easter eggs, malwares em geral ou outras
          rotinas de programação que possam danificar, interferir, interceptar
          ou desapropriar qualquer sistema, dado ou informação pessoal; (g) não
          ...
          quanto a cada vez que o seu e-mail mudar 3. Restrições no Nosso Uso de
          Suas Informações 3.1. Restrições no Nosso Uso de Suas Informações: Nós
          não venderemos, alugaremos ou divulgaremos nenhuma parte de Suas
          Informações para terceiros. 3.2. Ao aceitar estes Termos de Uso, você
          tem o direito não exclusivo, intransferível, não sub-licenciável e
          limitado de entrar em nossa Plataforma, acessar e usar os Serviços,
          unicamente para uso pessoal e não comercial. 3.3. Todos os direitos
          não previstos expressamente nestes Termos de Uso estão reservados ao
          Fica Fácil. 3.4. Você concorda que os Serviços são para o seu uso
          pessoal e não comercial e que ninguém além de você usará os Serviços.
          Você não tem direitos de cópia, reprodução ou alteração no todo ou em
          parte, de qualquer parte dos Serviços de propriedade do Fica Fácil.
          ...
          aplicáveis e ainda por estes Termos de Uso. 3.6. O Fica Fácil poderá
          modificar os Serviços e/ou Conteúdo ou descontinuar a sua
          disponibilidade a qualquer momento. Os serviços oferecidos nos
          aplicativos podem ser diferentes dos serviços oferecidos no site do
          Fica Fácil. 3.7. Você não deve tentar nem apoiar as tentativas de
          ...
          qualquer parte dos Serviços. 4. Requisitos de condições técnicas 4.1.
          O Membro entende que os Cursos do Fica Fácil requerem condições
        ...
        {/*  Continuar com os termos naype isso */}
      </article>
      <Checkbox
